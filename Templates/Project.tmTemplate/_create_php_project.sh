...
defaultProjectName="PHProject.tmproj";
defaultClassPrefix="PHPProject";
...
if [ -n "$fullProjectPath" ]; then
    ...
    if [ -n "$fullClassPath" ]; then
        ...
        classPath=`echo $classPath | tr '_' '/'`;
        classPathDirectory="$projectPath/$projectName/classes/$classPath/";
